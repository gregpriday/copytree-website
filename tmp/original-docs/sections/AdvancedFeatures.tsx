...
export default async function AdvancedFeatures() {
  return (
    <div className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <div className="my-8 not-prose">
        <h3 className="text-xl font-semibold text-foreground mb-4">GitHub Repository Support</h3>
        ...
        <div className="space-y-4">
          <div className="bg-muted rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Copy public repository</h4>
            <CodeBlock code="copytree https://github.com/facebook/react" language="bash" />
          </div>
          
          <div className="bg-muted rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Copy specific branch</h4>
            <CodeBlock code="copytree https://github.com/vercel/next.js --branch canary" language="bash" />
          </div>
          
          <div className="bg-muted rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Copy with authentication (private repos)</h4>
        ...
        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mt-6">
          <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">GitHub Integration Features</h4>
      ...
      <div className="my-8 not-prose">
        <h3 className="text-xl font-semibold text-foreground mb-4">Streaming Large Files</h3>
        <p className="text-muted-foreground mb-4">
          CopyTree automatically streams large files to handle massive codebases efficiently:
        </p>
        
        <div className="bg-gray-900 rounded-xl p-6 text-white">
          <h4 className="font-semibold text-primary-400 mb-3">Streaming Architecture</h4>
      ...
      {/* AI Cache System */}
      <div className="my-8 not-prose">
        <h3 className="text-xl font-semibold text-foreground mb-4">AI Cache System</h3>
        <p className="text-muted-foreground mb-4">
...
copytree cache:stats`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            ...
            <p className="text-sm text-muted-foreground">Improved efficiency for repeated runs on same codebase</p>
          </div>
          <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Cost Savings</h4>
            <p className="text-sm text-muted-foreground">Reduces AI API calls significantly</p>
          </div>
          <div className="bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Smart Invalidation</h4>
            <p className="text-sm text-muted-foreground">Auto-invalidates when files change</p>
          </div>
        </div>
      </div>
      ...
      <div className="my-8 not-prose">
        <h3 className="text-xl font-semibold text-foreground mb-4">Custom Pipeline Stages</h3>
        <p className="text-muted-foreground mb-4">
...
module.exports = {
  ...
  async process(files, options, context) {
    ...
    return processedFiles;
      ...
      <div className="my-8 not-prose">
        <h3 className="text-xl font-semibold text-foreground mb-4">Scripting and Automation</h3>
        <p className="text-muted-foreground mb-4">
...
# aws s3 sync "$OUTPUT_DIR" "s3://my-bucket/copytree-contexts/"`}
      ...
      <div className="my-8 not-prose">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-8 text-white">
          <h4 className="text-xl font-semibold text-primary-400 mb-4">Performance Tips</h4>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h5 className="font-semibold mb-2">File Selection</h5>
            ...
            <div>
              <h5 className="font-semibold mb-2">Caching</h5>
              <ul className="text-sm text-gray-300 space-y-1">
            ...
            <div>
              <h5 className="font-semibold mb-2">Concurrency</h5>
              <ul className="text-sm text-gray-300 space-y-1">
            ...
            <div>
              <h5 className="font-semibold mb-2">Output Size</h5>
              <ul className="text-sm text-gray-300 space-y-1">
      ...
      <div className="my-8 not-prose">
        <h3 className="text-xl font-semibold text-foreground mb-4">Environment Variables Reference</h3>
        
        <div className="bg-muted rounded-xl p-6">
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h5 className="font-mono text-sm font-semibold">COPYTREE_DEBUG</h5>
                <p className="text-xs text-muted-foreground">Enable debug logging (true/false)</p>
              </div>
              <div>
                <h5 className="font-mono text-sm font-semibold">COPYTREE_COLORS</h5>
                <p className="text-xs text-muted-foreground">Enable/disable colored output</p>
              </div>
              <div>
                <h5 className="font-mono text-sm font-semibold">COPYTREE_TIMEOUT</h5>
                <p className="text-xs text-muted-foreground">Global timeout in milliseconds</p>
              </div>
              <div>
                <h5 className="font-mono text-sm font-semibold">COPYTREE_TEMP_DIR</h5>
                <p className="text-xs text-muted-foreground">Custom temporary directory path</p>
              </div>
              <div>
                <h5 className="font-mono text-sm font-semibold">COPYTREE_PARALLEL_JOBS</h5>
                <p className="text-xs text-muted-foreground">Number of parallel processing jobs</p>
              </div>
              <div>
                <h5 className="font-mono text-sm font-semibold">COPYTREE_MEMORY_LIMIT</h5>
                <p className="text-xs text-muted-foreground">Maximum memory usage in MB</p>
              </div>
            </div>
          </div>
        </div>
