...
<div class="prose prose-neutral dark:prose-invert max-w-none">
  <h2 class="text-3xl font-bold text-foreground mb-4">Profiles</h2>
  ...
  <div class="my-8 not-prose">
    <h3 class="text-xl font-semibold text-foreground mb-4">Default Profile</h3>
  ...
  <!-- Using Profiles -->
  <div class="my-8 not-prose">
    <h3 class="text-xl font-semibold text-foreground mb-4">Using Profiles</h3>
    
    <div class="space-y-4">
      <div class="bg-muted rounded-lg p-4">
        <h4 class="font-medium text-foreground mb-2">Use default profile</h4>
        <CodeBlock code="copytree  # Uses default profile automatically" language="bash" />
      </div>
      
      <div class="bg-muted rounded-lg p-4">
        <h4 class="font-medium text-foreground mb-2">Use custom profile</h4>
        <CodeBlock code="copytree --profile mycustom" language="bash" />
      </div>
      
      <div class="bg-muted rounded-lg p-4">
        <h4 class="font-medium text-foreground mb-2">List available profiles</h4>
        <CodeBlock code="copytree profile:list" language="bash" />
      </div>
      
      <div class="bg-muted rounded-lg p-4">
        <h4 class="font-medium text-foreground mb-2">Show profile details</h4>
  ...
  <!-- Profile Examples -->
  <div class="my-8 not-prose">
    <h3 class="text-xl font-semibold text-foreground mb-4">Profile Examples</h3>
...
alwaysInclude:
  ...
  <div class="my-8 not-prose">
    <h3 class="text-xl font-semibold text-foreground mb-4">Creating Custom Profiles</h3>
    <p class="text-muted-foreground mb-4">
      Create custom profiles by adding YAML files to <code class="bg-muted px-2 py-1 rounded text-sm">.copytree/profiles/</code> in your project:
    </p>
...
options:
  ...
  <!-- Profile Inheritance -->
  <div class="my-8 not-prose">
    <h3 class="text-xl font-semibold text-foreground mb-4">Profile Inheritance</h3>
    <p class="text-muted-foreground mb-4">
    ...
    <div class="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
      <h4 class="font-semibold text-blue-900 dark:text-blue-100 mb-3">How inheritance works:</h4>
...
options:
  ...
  <!-- Best Practices -->
  <div class="my-8 not-prose">
    <h3 class="text-xl font-semibold text-foreground mb-4">Profile Best Practices</h3>
