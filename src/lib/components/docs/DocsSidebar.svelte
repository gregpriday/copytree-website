		...
		<div class="relative">
			...
			>
				<div class="relative">
					<!-- Glow effect -->
					<div
						class="bg-primary-400 animate-breathing absolute inset-0 h-2 w-2 rounded-full blur-sm"
					></div>
					<!-- Main pill -->
					<div
						class="from-primary-500 to-primary-600 relative h-2 w-2 rounded-full bg-gradient-to-br shadow-sm"
					></div>
				</div>
			</div>
				...
				{#each sections as section (section.id)}
					<li>
						<a
							...
							class="block py-1.5 pr-2 pl-4 transition-all duration-200 {activeSection ===
							section.id
