...
>
	<nav class="max-w-container mx-auto px-4 sm:px-6 lg:px-8" aria-label="Primary">
		...
		>
			<!-- Glass + blur (consistent) -->
			<div
				class="absolute inset-0 bg-white/85 dark:bg-zinc-950/90"
	...
	>
		<div class="relative overflow-hidden border-t border-border">
			<!-- Blur + tint -->
			<div
				class="absolute inset-0 bg-white/85 dark:bg-zinc-950/90"
				style="backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px);"
