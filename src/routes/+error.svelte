...
<section class="relative w-full overflow-hidden bg-background overflow-y-hidden" style="min-height: 100vh;">
  ...
  >
    ...
    <div
      class="flex w-full flex-col items-center justify-center gap-6 md:gap-8 text-center animate-fadeIn"
      style="
    ...
    >
      ...
      <div class="relative mx-auto w-fit">
        <LogoIcon size="lg" class="mx-auto hover:brightness-110 transition" />
        <div class="pointer-events-none absolute inset-0 rounded-full bg-primary/15 opacity-0 blur-xl transition-opacity duration-500 hover:opacity-100"></div>
      </div>

      <!-- Error code -->
      <div class="font-bold tracking-tight text-destructive" style="font-family: var(--font-space-grotesk);">
        <span class="text-7xl md:text-8xl lg:text-9xl select-none leading-none">{code}</span>
      </div>

      <!-- Heading -->
      <h1 class="text-2xl md:text-3xl font-bold text-foreground" style="font-family: var(--font-space-grotesk);">
        {title}
      </h1>
      ...
      <div class="mt-2 flex flex-col items-center justify-center gap-3 sm:flex-row">
        <a href="/" aria-label="Go to homepage">
          <Button
            size="lg"
            class="px-6 py-3 shadow-md transition-all hover:bg-primary/90"
          >
            <span>Go Home</span>
          </Button>
        </a>
        ...
        <Button
          variant="secondary"
          size="lg"
          class="px-6 py-3 border border-border bg-secondary/60 backdrop-blur-sm text-foreground hover:bg-secondary/80"
          onclick={refresh}
      ...
      <div class="mt-2">
        <a
          ...
          class="text-sm text-muted-foreground underline-offset-4 hover:text-foreground hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded"
        >
          Report an issue
        </a>
      </div>
    ...
    <div class="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-border/60 to-transparent"></div>
    <div class="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-border/60 to-transparent"></div>
  </div>
</section>
